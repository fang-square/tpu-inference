...
DUMP_DIR=/mnt/disks/persist/tmp/qwen32b_prefill_brpa_rope_kv_head_major_tp2_$(date +%Y%m%d_%H%M%S)
mkdir -p "$DUMP_DIR"
echo "================================================================================"
echo "Dumping Qwen3-32B HLO (TP=2) with KV-Head Major + In-Kernel RoPE:"
echo "  - Option: USE_KV_HEAD_MAJOR_IN_KERNEL_ROPE_RPA=1"
