...
DUMP_DIR=/mnt/disks/persist/tmp/qwen32b_prefill_brpa_rope_strided_dma_tp2_$(date +%Y%m%d_%H%M%S)
mkdir -p "$DUMP_DIR"
echo "================================================================================"
echo "Dumping Qwen3-32B HLO (TP=2) with Strided DMA + In-Kernel RoPE:"
