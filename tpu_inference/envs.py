...
if TYPE_CHECKING:
    ...
    USE_HEAD_MAJOR_Q_SEPARATE_KV_RPA: bool = False
    USE_OUT_TOKEN_MAJOR: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "USE_HEAD_MAJOR_Q_SEPARATE_KV_RPA":
    env_bool("USE_HEAD_MAJOR_Q_SEPARATE_KV_RPA", default=False),
    "USE_OUT_TOKEN_MAJOR":
    env_bool("USE_OUT_TOKEN_MAJOR", default=False),
